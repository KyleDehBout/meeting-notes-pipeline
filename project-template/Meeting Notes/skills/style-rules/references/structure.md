...
2. Attendees — three columns: Name / Organisation / Title
3. Main items table — columns: [Content] / Action / Status
4. Numbered top-level sections with bold title
5. Subsection labels
6. Numbered sub-items with Action and Status populated per row
7. Next meeting row
8. Prepared by line
-->
...
- Column 2: Action — organisation name only, centred
- Column 3: Status — one of the defined status values, centred
-->
[TO BE FILLED IN]
...
- Each sub-item row must have Action and Status populated — never blank
